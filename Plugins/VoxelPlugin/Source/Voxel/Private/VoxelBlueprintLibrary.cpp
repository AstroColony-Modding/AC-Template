...
void UVoxelBlueprintLibrary::SpawnVoxelSpawnerActorsInArea(TArray<AVoxelSpawnerActor*>& OutActors, AVoxelWorld* World, FVoxelIntBox Bounds, EVoxelSpawnerActorSpawnType SpawnType) {
}

AVoxelSpawnerActor* UVoxelBlueprintLibrary::SpawnVoxelSpawnerActorByInstanceIndex(AVoxelWorld* World, UVoxelHierarchicalInstancedStaticMeshComponent* Component, int32 InstanceIndex) {
    return NULL;
}
...
FVoxelPaintMaterial UVoxelBlueprintLibrary::CreateMultiIndexWetnessPaintMaterial(float WetnessValue) {
    return FVoxelPaintMaterial{};
}
...
bool UVoxelBlueprintLibrary::Compare_IntVectorIntVector(FIntVector Left, FIntVector Right) {
    return false;
}
...
void UVoxelBlueprintLibrary::AddInstances(AVoxelWorld* World, UStaticMesh* Mesh, const TArray<FTransform>& Transforms, const TArray<FLinearColor>& Colors, FVoxelInstancedMeshSettings InstanceSettings, FVoxelSpawnerActorSettings ActorSettings, FVector FloatingDetectionOffset) {
}
